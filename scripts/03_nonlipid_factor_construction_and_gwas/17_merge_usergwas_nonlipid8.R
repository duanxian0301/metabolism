...
merge_one("F1", file.path(merged_dir, "nonlipid_final8_F1_userGWAS_merged.tsv.gz"))
merge_one("F2", file.path(merged_dir, "nonlipid_final8_F2_userGWAS_merged.tsv.gz"))
merge_one("F3", file.path(merged_dir, "nonlipid_final8_F3_userGWAS_merged.tsv.gz"))
merge_one("Q_SNP", file.path(merged_dir, "nonlipid_final8_QSNP_userGWAS_merged.tsv.gz"))
