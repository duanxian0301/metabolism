...
$OutputRoot = "/home/shenjing/ctwas_paths/metabolic_mctwas_work_nonlipid8_F1_PD"
...
wsl -e bash -lc "Rscript $Script --trait nonlipid8_F1 --gwas-file /mnt/d/codex/GenomicSEM/metabolic/postgwas_ad_pdlbd/work/clean_factor_inputs/nonlipid8_F1_clean.txt --output-root $OutputRoot --ncore 4 --niter-prefit 3 --niter 30 --L 5 --seed 20260429"
